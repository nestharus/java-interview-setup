...
public class TestGlobalExceptionHandler {
  ...
  void handleIllegalArgumentException() throws Exception {
    ...
    mockMvc.perform(get("/mock-controller/trigger-exception"))
  ...
  void handleOptimisticLockingFailureException() throws Exception {
    ...
    mockMvc.perform(get("/mock-controller/trigger-exception"))
        ...
        .andExpect(content().string("Conflict: The data was modified by another user. Please refresh and try again."));
  }
  ...
  void handleDataIntegrityViolationException() throws Exception {
    ...
    mockMvc.perform(get("/mock-controller/trigger-exception"))
        .andExpect(status().isConflict())
        .andExpect(content().string("Data conflict or integrity violation. Please check your input."));
  }
